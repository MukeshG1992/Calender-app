...
public class AllInOneActivity extends AbstractCalendarActivity implements EventHandler,
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                cb.setDebugEnabled(true)
                        .setOAuthConsumerKey("IXJTMZRCoCPs0pnZfODmpvCem")
                        .setOAuthConsumerSecret(
                                "ReF3xJiSdFcePKeFv2or5JFDxERnkgKBjEl1u9tc6zgsmmgvl7")
                        .setOAuthAccessToken(
                                "580688604-FsMXIhAgOVLuMvpieiwTFLHAerMvUXmdvvq6Zsal")
                        .setOAuthAccessTokenSecret(
                                "93IEkCWSikYPQw6RsjifUu70COSOJumHQyXTFUyhKh1XJ");
    ...
    public void onClickSlogan(View v)
    {
         tvSlogan.setLayoutParams(new  LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.WRAP_CONTENT));
    }
    public void getSlogan() {

        final String[] slogan = getResources().getStringArray(R.array.modiSlogan);
        Timer timer = new Timer();
            ...
            timer.scheduleAtFixedRate(new TimerTask() {
                ...
                public void run() {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            tvSlogan.setLayoutParams(new  LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,126));
                            tvSlogan.setText("Slogan : "+slogan[finalI1]);
            ...
            timer.scheduleAtFixedRate(new TimerTask() {
                ...
                public void run() {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            tvSlogan.setLayoutParams(new  LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,126));
                            tvSlogan.setText("Tweet : "+ list.get(finalI1));
