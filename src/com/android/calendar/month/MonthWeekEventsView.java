...
public class MonthWeekEventsView extends SimpleWeekView {
    ...
    private static int EVENT_TEXT_COLOR = Color.TRANSPARENT;//Color.WHITE;
    ...
    protected void loadColors(Context context) {
        ...
        if (theme.equals("dark")) {
            mMonthWeekNumColor = Color.rgb(66,155,244);//res.getColor(R.color.month_week_num_color_dark);
            mMonthNumColor = Color.rgb(66,155,244);//res.getColor(R.color.month_day_number_dark);
            mMonthNumOtherColor = Color.rgb(232,150,37);//res.getColor(R.color.month_day_number_other_dark);
            mMonthNumTodayColor = Color.rgb(66,155,244);//res.getColor(R.color.month_today_number_dark);
            mMonthEventColor = Color.TRANSPARENT;//res.getColor(R.color.month_event_color_dark);
            mMonthDeclinedEventColor = Color.TRANSPARENT;//res.getColor(R.color.agenda_item_declined_color_dark);
            mMonthDeclinedExtrasColor =Color.TRANSPARENT;// res.getColor(R.color.agenda_item_where_declined_text_color_dark);
            mMonthEventExtraColor = Color.TRANSPARENT;//res.getColor(R.color.month_event_extra_color_dark);
            mMonthEventOtherColor = Color.TRANSPARENT;//res.getColor(R.color.month_event_other_color_dark);
            mMonthEventExtraOtherColor = Color.TRANSPARENT;//res.getColor(R.color.month_event_extra_other_color_dark);
            mMonthBGTodayColor = res.getColor(R.color.month_today_bgcolor_dark);
            mMonthBGFocusMonthColor = Color.TRANSPARENT;//res.getColor(R.color.month_focus_month_bgcolor_dark);
            mMonthBGOtherColor = Color.TRANSPARENT;//res.getColor(R.color.month_other_bgcolor_dark);
            mMonthBGColor = Color.TRANSPARENT;//res.getColor(R.color.month_bgcolor_dark);
            mDaySeparatorInnerColor = Color.TRANSPARENT;//res.getColor(R.color.month_grid_lines_dark);
            ...
            mMonthWeekNumColor =Color.rgb(66,155,244);// res.getColor(R.color.month_week_num_color);
            mMonthNumColor = Color.rgb(66,155,244);//res.getColor(R.color.month_day_number);
            mMonthNumOtherColor = Color.rgb(232,150,37);//res.getColor(R.color.month_day_number_other);
            mMonthNumTodayColor =Color.rgb(66,155,244);// res.getColor(R.color.month_today_number);
            mMonthEventColor = Color.TRANSPARENT;//res.getColor(R.color.month_event_color);
            mMonthDeclinedEventColor = Color.TRANSPARENT;//res.getColor(R.color.agenda_item_declined_color);
            mMonthDeclinedExtrasColor = Color.TRANSPARENT;//res.getColor(R.color.agenda_item_where_declined_text_color);
            mMonthEventExtraColor =Color.TRANSPARENT;// res.getColor(R.color.month_event_extra_color);
            mMonthEventOtherColor = Color.TRANSPARENT;//res.getColor(R.color.month_event_other_color);
            mMonthEventExtraOtherColor = Color.TRANSPARENT;//res.getColor(R.color.month_event_extra_other_color);
            mMonthBGTodayColor = Color.argb(128,232,82,37);//res.getColor(R.color.month_today_bgcolor);
            mMonthBGFocusMonthColor = Color.TRANSPARENT;//res.getColor(R.color.month_focus_month_bgcolor);
            mMonthBGOtherColor = Color.TRANSPARENT;//res.getColor(R.color.month_other_bgcolor);
            mMonthBGColor = Color.TRANSPARENT;//res.getColor(R.color.month_bgcolor);
            mDaySeparatorInnerColor = Color.TRANSPARENT;//res.getColor(R.color.month_grid_lines);
